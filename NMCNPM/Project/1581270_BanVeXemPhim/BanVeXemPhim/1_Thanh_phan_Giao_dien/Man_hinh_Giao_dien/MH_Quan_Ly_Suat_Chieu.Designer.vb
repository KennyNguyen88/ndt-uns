...
Partial Class MH_Quan_Ly_Suat_Chieu
    ...
    Private Sub InitializeComponent()
        ...
        Me.Panel2.Controls.Add(Me.cbPhim_Them)
        ...
        Me.Name = "MH_Quan_Ly_Suat_Chieu"
        Me.Text = "MH_Quan_Ly_Suat_Chieu"
    ...
    Friend WithEvents dtNgay_Them As DateTimePicker
    Friend WithEvents Label3 As Label
    Friend WithEvents Label4 As Label
    Friend WithEvents cbCaChieu_Them As ComboBox
    Friend WithEvents cbPhong_Them As ComboBox
    Friend WithEvents Label7 As Label
    Friend WithEvents Label5 As Label
    Friend WithEvents cbPhim_Them As ComboBox
End Class
