...
' Thông báo PET : Với mục tiêu giảng dạy. Class này được thiết kế theo hướng 
'  1. Đặc thù cho ứng dụng QLNV_1 
'  2. Tổng quát cho các loại  qui mô khác nhau  ( sẽ có các CSDL khác nhau )
