<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WUC_MemberSucceed.ascx.cs" Inherits="KiemTra02.WUC.WUC_MemberSucceed" %>
<div class='container'>
    <div class='row' style='padding-top: 25px; padding-bottom: 25px;'>
        <div class='col-md-12'>
            <div id='mainContentWrapper'>
                <div class="col-md-8 col-md-offset-2">
                    <h2 style="text-align: center;">Your order has been proceed successfully !
                    </h2>
                    <hr />
