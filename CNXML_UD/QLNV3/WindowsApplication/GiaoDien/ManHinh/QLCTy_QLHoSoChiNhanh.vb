Public Class QLCTy_QLHoSoChiNhanh
    ...
    Sub KhoiDong()
        'form
        Me.Text = FormatIF.QLCTy_QLHoSoChiNhanh_form_title
        ...
        TheHien.Dinh_Dang_Button_Menu_Active(btnHSCN)
        ...
        'main
        lbTitle.Text = FormatIF.QLCTy_QLHoSoChiNhanh_pnTop_title
