...
#Region "Biếu tượng"
    Public Sub Xuat_Danh_sach_Chon_Gioi_tinh(Danh_sach As DataTable, Th_Danh_sach As FlowLayoutPanel,
        ...
        For Each Doi_tuong As DataRow In Danh_sach.Rows
            ...
            Th_Doi_tuong.ForeColor = Color.DarkCyan
            Th_Doi_tuong.Font = New Font("Arial", 12)
            Th_Doi_tuong.AutoSize = True
            Th_Doi_tuong.Size = New Size(90, 30)
            '===Chuẩn bị biến cố  
