...
public partial class XL_LUU_TRU
{
    ...
    public static XL_CONG_TY Tao_Cong_Ty()
    {
        var Cong_Ty = new XL_CONG_TY();
        Cong_Ty.Danh_sach_Nhan_vien = Doc_Danh_sach_Nhan_vien();
        Cong_Ty.Danh_sach_Nhom_hang = Doc_Danh_sach_Nhom_hang();
        Cong_Ty.Danh_sach_Quan_ly = Doc_Danh_sach_Quan_ly();
        return Cong_Ty;
    }
